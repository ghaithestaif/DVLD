        ...
        private bool _HandlePrviousTestConstraint()
        {
            ...
            switch (TestTypeID)
            {
                ...
                case clsTestType.enTestType.WrittenTest:
                    ...
                    if (!_LocalDrivingLicenseApplication.DoesPersonPassedTest((int)clsTestType.enTestType.VisionTest))
                    {
                ...
                case clsTestType.enTestType.StreetTest:
                    ...
                    if (!_LocalDrivingLicenseApplication.DoesPersonPassedTest((int)clsTestType.enTestType.WrittenTest))
                    {
