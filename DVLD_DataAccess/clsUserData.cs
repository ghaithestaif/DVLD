...
public class clsUserData
{
    ...
    private static readonly Dictionary<UsersFilter, string> _UserColumnMap = new Dictionary<UsersFilter, string>()
    {
        { UsersFilter.UserID, "UserID" },
        { UsersFilter.PersonID, "People.PersonID" },
        { UsersFilter.UserName, "UserName" },
        { UsersFilter.FullName, "FullName"   },
        { UsersFilter.IsActive, "IsActive" }
    };
    ...
    //public static DataTable FilterUsers(UsersFilter filterBy, string filterExpression)
    //{
    //    if (filterBy == UsersFilter.None)
